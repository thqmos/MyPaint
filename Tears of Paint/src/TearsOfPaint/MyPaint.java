...
//Lots of imports necessary for Tears of Paint
...
public class MyPaint extends Application{
    ...
    protected double rectx2;
    protected double recty2;
    ...
    //This assists us in the move/paste
    private int clicked;
    
    //This assists us in the undo/redo images
    ...
    public void start(Stage frame) throws Exception{
        ...
        //What if the mouse is pressed on the canvas?
        canvas.setOnMousePressed(eh -> {
            ...
            else if (myToolBar.Rounded.isSelected() == true) {
                rectx = eh.getX();
                recty = eh.getY();
                addUndo(undoHistory, canvas);
            }
            //What if the eraser tool is selected
            else if(myToolBar.Eraser.isSelected() == true){
                rectx = eh.getX();
                recty = eh.getY();
                addUndo(undoHistory, canvas);
            }
            //What if the Polygon tool is selected?
            else if (myToolBar.Polygon.isSelected() == true) {
                rectx = eh.getX();
                recty = eh.getY();
                addUndo(undoHistory, canvas);
            }
            //What if the move tool is selected?
            else if (myToolBar.MovePaste.isSelected() == true){
                rectx = eh.getX();
                recty = eh.getY();
                addUndo(undoHistory, canvas);
            }
        ...
        canvas.setOnMouseDragged(eh -> {
            ...
            //What if the circle tool is selected?
                ...
                if (rectx2 > rectx && recty2 > recty) {
                    ...
                    double rectheight = recty2 - recty;
                    if (myToolBar.check.isSelected() == true) {
                        graphic.strokeRoundRect(rectx, recty, rectwidth, rectheight, 10, 10);
                        graphic.fillRoundRect(rectx, recty, rectwidth, rectheight, 10, 10);
                    } else {
                        graphic.strokeRoundRect(rectx, recty, rectwidth, rectheight, 10, 10);
                    }
                    ...
                    double rectheight = recty - recty2;
                    if (myToolBar.check.isSelected() == true) {
                        graphic.strokeRoundRect(rectx, recty2, rectwidth, rectheight, 10, 10);
                        graphic.fillRoundRect(rectx, recty2, rectwidth, rectheight, 10, 10);
                    } else {
                        graphic.strokeRoundRect(rectx, recty2, rectwidth, rectheight, 10, 10);
                    }
                    ...
                    double rectheight = recty2 - recty;
                    if (myToolBar.check.isSelected() == true) {
                        graphic.strokeRoundRect(rectx2, recty, rectwidth, rectheight, 10, 10);
                        graphic.fillRoundRect(rectx2, recty, rectwidth, rectheight, 10, 10);
                    } else {
                        graphic.strokeRoundRect(rectx2, recty, rectwidth, rectheight, 10, 10);
                    }
                    ...
                    double rectheight = recty - recty2;
                    if (myToolBar.check.isSelected() == true) {
                        graphic.strokeRoundRect(rectx2, recty2, rectwidth, rectheight, 10, 10);
                        graphic.fillRoundRect(rectx2, recty2, rectwidth, rectheight, 10, 10);
                    } else {
                        graphic.strokeRoundRect(rectx2, recty2, rectwidth, rectheight, 10, 10);
                    }
            ...
            //What if the eraser tool is selected?
                ...
                rectx2 = eh.getX();
                recty2 = eh.getY();
                graphic.setLineWidth(myToolBar.slider1.getValue());
            ...
            //What if the Polygon tool is selected?
                ...
                recty2 = eh.getY();
                initRect(graphic, myToolBar.slider1, myToolBar.colorPicker, myToolBar.c22);
                double polyradius = Math.sqrt((Math.pow((rectx2 - rectx), 2) + Math.pow((recty2 - recty), 2)));
                int sides = parseInt(myToolBar.polytext.getText());
                ...
                for (int i = 0; i < sides; i++){
                    xarr[i] = ((rectx + (polyradius * Math.cos((2*Math.PI*i)/sides))));
                    yarr[i] = ((recty + (polyradius * Math.sin((2*Math.PI*i)/sides))));
                }
                
                //To fill or not to fill, that is the question.
                if(myToolBar.check.isSelected()){
        ...
        canvas.setOnMouseReleased(eh -> {
            ...
            //What if the move tool is selected
                ...
                if (rectx2 > rectx && recty2 > recty) {
                    ...
                    Image writable = canvas.snapshot(null, null);
                    ...
                    subImage.createGraphics().drawImage(image.getSubimage((int) rectx, (int) recty, (int) rectwidth, (int) rectheight), 0, 0, null);
                    ...
                    canvas.setOnMouseClicked(e -> {
                        if (clicked == 0){
                            ...
                            w.cancel();
                            System.gc();
                            myToolBar.MovePaste.setSelected(false);
                    ...
                    BufferedImage image = SwingFXUtils.fromFXImage(writable, null);
                    BufferedImage subImage = new BufferedImage((int) rectwidth, (int) rectheight, BufferedImage.OPAQUE);
                    subImage.createGraphics().drawImage(image.getSubimage((int) rectx, (int) recty2, (int) rectwidth, (int) rectheight), 0, 0, null);
                    Image w = SwingFXUtils.toFXImage(subImage, null);
                    graphic.fillRect(rectx, recty2, rectwidth, rectheight);
                    canvas.setOnMouseClicked(e -> {
                        if (clicked == 0){
                    ...
                    BufferedImage image = SwingFXUtils.fromFXImage(writable, null);
                    BufferedImage subImage = new BufferedImage((int) rectwidth, (int) rectheight, BufferedImage.OPAQUE);
                    subImage.createGraphics().drawImage(image.getSubimage((int) rectx2, (int) recty, (int) rectwidth, (int) rectheight), 0, 0, null);
                    Image w = SwingFXUtils.toFXImage(subImage, null);
                    graphic.fillRect(rectx2, recty, rectwidth, rectheight);
                    canvas.setOnMouseClicked(e -> {
                        if (clicked == 0){
                    ...
                    //What if it goes up and to the left?
                } else if (rectx > rectx2 && recty > recty2){
                    double rectw = rectx - rectx2;
                    double recth = recty - recty2;
                    ...
                    subImage.createGraphics().drawImage(image.getSubimage((int) rectx2, (int) recty2, (int) rectw, (int) recth), 0, 0, null);
                    Image w = SwingFXUtils.toFXImage(subImage, null);
                    graphic.fillRect(rectx2, recty2, rectw, recth);
        ...
        //This is how we undo
        myMenuBar.Undo.setOnAction(eh -> {
            if(!undoHistory.empty()){
                WritableImage neww = new WritableImage((int) canvas.getWidth(), (int) canvas.getHeight());
                canvas.snapshot(null, neww);
    ...
    public void addUndo(Stack<Image> UndoHistory, Canvas canvas){
